...
namespace Dash.Engine
{
    ...
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        public Vector4 Row1 { get { return row1; } }
        public Vector4 Row2 { get { return row2; } }
        public Vector4 Row3 { get { return row3; } }
        public Vector4 Row4 { get { return row4; } }

        public Vector4 Column1 { get { return new Vector4(row1.X, row2.X, row3.X, row4.X); } }
        public Vector4 Column2 { get { return new Vector4(row1.Y, row2.Y, row3.Y, row4.Y); } }
        public Vector4 Column3 { get { return new Vector4(row1.Z, row2.Z, row3.Z, row4.Z); } }
        public Vector4 Column4 { get { return new Vector4(row1.W, row2.W, row3.W, row4.W); } }
        ...
        {
            get { return (y == 0 ? row1 : (y == 1 ? row2 : (y == 2 ? row3 : row4)))[x]; }
            set
            {
                Vector4 row = (y == 0 ? row1 : (y == 1 ? row2 : (y == 2 ? row3 : row4)));
                row[x] = value;
            }
        }
        ...
        {
            Vector4 trans = this[3];
            return trans.Xyz;
        }

        public Matrix4 ClearTranslation()
        {
            Matrix4 clearTransMatrix = new Matrix4(this);
            clearTransMatrix[3] = new Vector4(0, 0, 0, 1);
            return clearTransMatrix;
        }
        ...
        {
            Matrix4 result = Matrix4.Identity;
            result[3] = new Vector4(x, y, z, 1.0f);
            return result;
        }
